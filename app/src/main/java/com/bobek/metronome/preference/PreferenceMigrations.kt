...
private const val MIGRATION_V5 = "migration_v5"
...
class PreferenceMigrations(context: Context) {
     ...
     */
    fun migrateV5() {
        val migrated = sharedPreferences.getBoolean(MIGRATION_V5, false)
        ...
        if (!migrated) {
            ...
            sharedPreferences.edit {
                ...
                putBoolean(MIGRATION_V5, true)
            }

            Log.i(TAG, "V5 - night_mode preference migrated")
        }
    }
}
